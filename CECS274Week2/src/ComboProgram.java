...
public static void main(String[] args) {
 ...
 // int ticks2 = 3;    // so we want to get 3, when ex is 10, and ex2 is 13. well. 13-10 = 3
  ...
  int ticks3;  // goal is to get ticks3 to equal 26, when ex is 10, ex2 is 13, and when ex3 is 27.
  ...
  ticks3 = (ex3 > ex2 ) ? ex3-ex2+ex2 : ex2-ex3 ;   // expression 2 or false value is currently . true condition expression 1 is ex3-ex2+ex2. so ticks3 = expression1 whenever ex3 > ex2. 
